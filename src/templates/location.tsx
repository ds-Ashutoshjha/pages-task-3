        ...
        <AnalyticsScopeProvider name={""}>
          <PageLayout
            ...
            title={name}
               >
            {/* <PhotoSlider
              bannerImage={_site.c_bannerimages}
              bannercta={c_bannerButton}
              c_bannerTagline={c_bannerTagline}
              title={name}
              c_bannerButton={c_bannerButton}
              bannerCTA={_site?.c_locatorSliderButton}
              sliderHeading={_site?.c_locatorSliderHeading}
            /> */}
