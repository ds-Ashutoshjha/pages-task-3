export const stagingBaseurl =
  "https://master-broadly--fluffy--fowl-sbx-pgsdemo-com.sbx.preview.pagescdn.com/";
...
export const favicon =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXShIPdY5hVjr-9ksQXnJKu-RJG972WlHt2w&usqp=CAU";
...
export const center_latitude = 26.9124;
export const center_longitude = 75.7873;
...
<path d="M877,4760h5a1,1,0,0,0,1-1v-8.59l.293.3a1,1,0,1,0,1.414-1.42l-9-9a1,1,0,0,0-1.414,0l-9,9a1,1,0,0,0,1.414,1.42l.293-.3V4759a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1v-5h2v5A1,1,0,0,0,877,4760Zm4-2h-3v-5a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1v5h-3v-9.59l6-6,6,6Z" transform="translate(-865 -4739.998)" fill="#D73C7A" fill-rule="evenodd"/>
</svg>`;
...
export const Openclose = `<svg xmlns="http://www.w3.org/2000/svg" class="notHighlight cursor-pointer ml-1" width="9.585" height="4.793" viewBox="0 0 9.585 4.793">
...
export const logo = `<svg class="hidden lg:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 232 96">
...
</svg><svg class="lg:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 143 56">
<g fill="none" fill-rule="evenodd">
  <path fill="#AD1E1F" d="M0 56h143V0H0z"></path>
  <path fill="#FFF" fill-rule="nonzero" d="M138.751 7l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.019l-5-.009a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.019l-5-.009a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.018l-5-.009a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .002-1.5zm-10-.019l-5-.009a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .003-1.5zm-10-.018l-5-.009a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .003-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .003-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .003-1.5zm-10-.019l-5-.009a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .003-1.5zm-10-.018l-5-.01a.75.75 0 0 0-.002 1.5l5 .01a.75.75 0 0 0 .003-1.5z"></path>
  <g fill="#FEFEFE">
    <path d="M119.7 23.032v11.901L109.103 23.03l-1.594.003v13.934h1.4V25.065l10.55 11.856.039.044 1.603.002V23.032zM101.407 31.26h-6.34l3.17-6.308 3.17 6.309zm-2.434-8.158l-.036-.072h-1.401l-7.05 13.938 1.665-.003 2.265-4.437h7.641l2.265 4.437 1.665.003-7.014-13.866zM80.42 35.7V23.032h-1.4v13.935h9.944V35.7zM72.918 31.26h-6.34l3.17-6.308 3.17 6.309zm-2.434-8.158l-.036-.072h-1.4l-7.05 13.938 1.664-.003 2.265-4.437h7.641l2.265 4.437 1.665.003-7.014-13.866zM53.395 23.032V24.3h4.915v12.667h1.4V24.3h4.916v-1.268zM51.45 31.26h-6.341l3.17-6.308 3.17 6.309zm-2.4-8.09l-.07-.14h-1.401l-7.05 13.938 1.665-.003 2.265-4.437h7.64l2.266 4.437 1.665.003-6.98-13.799zM37.127 23.032h-1.73l-5.394 11.839-5.392-11.839h-1.73L21 36.967h1.487l1.568-11.666 5.29 11.668.658-.001h.658l5.291-11.667 1.568 11.666h1.487z"></path>
  </g>
</g>
</svg>`;
...
export const search_icn = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 30.938 30.579"><g id="Icon_feather-search" data-name="Icon feather-search" transform="translate(-3 -3)"><path id="Path_39" data-name="Path 39" d="M24.691,14.6A10.1,10.1,0,1,1,14.6,4.5,10.1,10.1,0,0,1,24.691,14.6Z" transform="translate(0 0)" fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path><path id="Path_40" data-name="Path 40" d="M35.066,34.707,24.975,24.975" transform="translate(-3.249 -3.249)" fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path></g></svg>`;
